...
if(isset($submit))
{
	$rs=mysqli_query($conn,"select * from user_info where username='$username' and password='$password'");
...
<?php
	echo "Welcome " . $_SESSION["login"]?>. Click here to <a  href="logout.php" tite="Logout">Logout.</a> <a href="updateuser.php" tite="Update">Update Account</a> <a href="deleteuser.php" tite="Delete">Delete Account</a> 
...
<?php
		  if(isset($found))
		  {
		  	echo '<p class="w3-center w3-text-red">Invalid username or password<br><a href="login.php">Please try again</p>';
		  }
		  ?>
 </center>
</form>
